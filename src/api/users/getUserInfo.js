...
function normalizeV2User(u) {
  ...
  return {
    ...
    coverPhoto: u.cover_photo?.source || u.cover_photo?.uri || null,
...
function normalizePrimaryActor(a) {
  ...
  return {
    ...
    coverPhoto: a.cover_photo?.source || a.cover_photo?.uri || null,
...
function mergeUserEntry(a, b) {
  ...
  return {
    ...
    coverPhoto: x.coverPhoto || y.coverPhoto || null,
    ...
    function formatLegacyData(data) {
      ...
      for (const prop in data) {
        ...
        retObj[prop] = {
          ...
          coverPhoto: innerObj.coverPhoto || innerObj.cover_photo || null,
